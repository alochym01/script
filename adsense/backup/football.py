...
def xml_parse(entry, updatevideoId):
    ...
    print str(updatevideoId), str( videoId)
        ...
        try:
            ...
            for file_mp4 in os.listdir("/home/hadn/Downloads/adsense/football/"):
                if file_mp4.endswith(".mp4"):
                    cmd = '/home/hadn/Downloads/adsense/python/bin/python /home/hadn/Downloads/adsense/haloha201-upload-youtube.py --file "/home/hadn/Downloads/adsense/football/%s" --title "%s" --description "%s"' % (file_mp4, value['title'], value['title'])
                    cmd = shlex.split(cmd)
