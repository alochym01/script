...
def add_video_to_playlist(videoId):
    cmd = '/home/hadn/Downloads/adsense/python/bin/python /home/hadn/Downloads/adsense/wowebookpro/playlist_item.py %s' % videoId
    cmd = shlex.split(cmd)
    print cmd
    try:
        up = Popen(cmd, stdout=PIPE)
...
def upload_youtube1(link):
    #cmd = '/home/hadn/Downloads/adsense/python/bin/python /home/hadn/Downloads/adsense/vtv_detail_v2.py %s' % link
