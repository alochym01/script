...
with open('/home/hadn/script/channel_ID.txt') as f:
...
print sys.argv[1]
playlistId = 'PLDuxenf8jCsS3gNBwSuYtWvnnILFq0rLO'
url = 'https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&playlistId=%s&key=%s' % (sys.argv[1], APIkey)
print url
while True:
    rv = requests.get(url)
    items = rv.json()['items']
